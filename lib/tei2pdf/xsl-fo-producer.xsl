  ...
  <xsl:template name="head">
    ...
    <xsl:choose>
      ...
      <xsl:when test="$output = 'pdf'">
        ...
        <xsl:attribute name="color">#41647C</xsl:attribute><!-- DHd2024 Donau Blau -->
      </xsl:when>
    </xsl:choose>
    <xsl:attribute name="space-before">.2in</xsl:attribute>
    <xsl:attribute name="space-after">.2in</xsl:attribute>
...
<!-- Spezialfall: Bild in Tabelle -->
  ...
  <xsl:variable name="header_and_footer">
    <fo:static-content flow-name="before-even">
      ...
      <fo:block><xsl:call-template name="page_header"/>Digital Humanities im deutschsprachigen Raum 2024</fo:block>
    </fo:static-content>
    ...
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:fox="http://xmlgraphics.apache.org/fop/extensions">
      ...
      <xsl:if test="$output = 'pdf'">
        <fo:page-sequence master-reference="Full">
          <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block>
                 <fo:external-graphic src="../../../input/deckblatt/DHd2024_BoA_Cover_v6.pdf#page=1"
      ...
      <xsl:if test="$output = 'pdf'">
        <fo:page-sequence master-reference="Full">
          ...
          <!-- <fo:flow flow-name="xsl-region-before"> -->
              ...
              <xsl:attribute name="format">i</xsl:attribute>
            <fo:block>
                 <fo:external-graphic src="../../../input/deckblatt/DHd2024_Logos_v8.pdf#page=1"
                                    content-width="scale-to-fit"
                                     content-height="scale-to-fit"
                                     scaling="uniform" />
            </fo:block>
      ...
      <xsl:if test="$output = 'pdf'">
        ...
        <!-- <fo:page-sequence master-reference="Full"> -->
          <!-- <fo:flow flow-name="xsl-region-before"> -->
            <fo:block>
                 <fo:external-graphic src="../../../input/deckblatt/DHd2024_Titlepage.pdf#page=1"
                                    content-width="scale-to-fit"
                                     content-height="scale-to-fit"
                                     scaling="uniform" />
            </fo:block>
      ...
      <xsl:if test="$output = 'pdf'">
        <fo:page-sequence master-reference="Full">
          <fo:flow flow-name="xsl-region-body">
            <fo:block>
                 <fo:external-graphic src="../../../input/deckblatt/DHd2024_ReviewerDeckblatt_Times.pdf#page=1"
                                    content-width="scale-to-fit"
                                     content-height="scale-to-fit"
                                     scaling="uniform" />
            </fo:block>
      ...
      <xsl:if test="$output = 'pdf'">
        <fo:page-sequence master-reference="Full">
          <fo:flow flow-name="xsl-region-body">
            <fo:block>
                 <fo:external-graphic src="../../../input/deckblatt/DHd2024_ReviewerDeckblatt_Times.pdf#page=2"
                                    content-width="scale-to-fit"
                                     content-height="scale-to-fit"
                                     scaling="uniform" />
            </fo:block>
